...
#define OLED_CS_Clr()  HAL_GPIO_WritePin(LCD_CE_GPIO_Port,LCD_CE_Pin,GPIO_PIN_RESET);
#define OLED_CS_Set()  HAL_GPIO_WritePin(LCD_CE_GPIO_Port,LCD_CE_Pin,GPIO_PIN_SET);
...
//		dat<<=1;   
//	}	
   HAL_SPI_Transmit(&hspi1,(uint8_t *)&dat,1,1);	
	OLED_CS_Set();
	OLED_DC_Set();   	  
} 
//#endif
